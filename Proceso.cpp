...
struct libro {
    ...
    string descripcion;
    string categoria;
    int disponibilidad; // Nuevo campo para la disponibilidad de libros
};

void imprimirBoleta(string username, libro libroAdquirido, int cantidad) {
    ofstream archivo("boleta.txt", ios::out);
...
void tiendabusqueda(string username) {
    ...
    libro libros[5] = {
        {1, "El Señor de los Anillos", "J.R.R. Tolkien", 39.0, "Una epica aventura de fantasía", "Aventura", 10},
        {2, "Harry Potter y la Piedra Filosofal", "J.K. Rowling", 30.0, "Una emocionante aventura de magia", "Aventura", 10},
        {3, "El Principito", "Antoine de Saint-Exupéry", 41.0, "Una conmovedora historia de amistad", "Fantasia", 10},
        {4, "Cien años de soledad", "Gabriel García Márquez", 42.0, "Una novela de realismo mágico", "Realismo", 10},
        {5, "El Alquimista", "Paulo Coelho", 43.0, "Una inspiradora historia de auto-descubrimiento", "Fantasia", 10}
    };
    ...
    do {
            ...
            switch (li) {
                case 1:
                    ...
                    for (int i = 0; i < 5; i++) {
                        ...
                        cout << "Disponibilidad: " << libros[i].disponibilidad << endl;
                        cout << "------------------------\n" << endl;
                    }
                    break;
                case 2:
        ...
        if (bl >= 0 && bl < 5) {
            ...
            cout << "Disponibilidad: " << libros[bl].disponibilidad << endl;
            cout << "------------------------\n" << endl;

            cout << "Desea saber más del libro? (1: Sí, 0: No)" << endl;
            cin >> sdl;
            if (sdl == 1) {
            ...
            if (al == 1) {
                ...
                cin >> canli;
                if (canli > libros[bl].disponibilidad) {
                    cout << "No hay suficientes libros disponibles." << endl;
                } else {
                    libros[bl].disponibilidad -= canli;
